...
import { Package, DollarSign, ShoppingCart, Users, Eye, Edit } from "lucide-react"
    ...
    <div className="min-h-screen bg-black text-white p-4 md:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">Manage orders, payments, and view analytics</p>
        </div>
                ...
                <tr className="border-b border-gray-800">
                  ...
                  <td className="py-4 px-2">
                    <select
                      ...
                      onChange={(e) => handleStatusChange("ORD-001", e.target.value)}
                      className={
                ...
                <tr className="border-b border-gray-800">
                  ...
                  <td className="py-4 px-2">
                    <select
                      ...
                      onChange={(e) => handleStatusChange("ORD-002", e.target.value)}
                      className={
                        "px-3 py-1 rounded-full text-xs font-medium " +
                ...
                <tr className="border-b border-gray-800">
                  ...
                  <td className="py-4 px-2">
                    <select
                      ...
                      onChange={(e) => handleStatusChange("ORD-003", e.target.value)}
                      className={
                        "px-3 py-1 rounded-full text-xs font-medium " +
                ...
                <tr className="border-b border-gray-800">
                  ...
                  <td className="py-4 px-2">
                    <select
                      ...
                      onChange={(e) => handleStatusChange("ORD-004", e.target.value)}
                      className={
                        "px-3 py-1 rounded-full text-xs font-medium " +
                ...
                <tr className="border-b border-gray-800">
                  ...
                  <td className="py-4 px-2">
                    <select
                      ...
                      onChange={(e) => handleStatusChange("ORD-005", e.target.value)}
                      className={
                        "px-3 py-1 rounded-full text-xs font-medium " +
                ...
                <tr className="border-b border-gray-800">
                  ...
                  <td className="py-4 px-2">
                    <select
                      ...
                      onChange={(e) => handleStatusChange("ORD-006", e.target.value)}
                      className={
                        "px-3 py-1 rounded-full text-xs font-medium " +
